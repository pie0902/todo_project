...
public class CommentApiController {
    ...
    public ResponseEntity<?> updateComment(@PathVariable Long articleId, @RequestBody UpdateCommentRequest request,
        @PathVariable Long commentId){
        System.out.println("Received update request for comment: " + request.getContent()); // 요청된 내용을 로깅
        Comment updateComment = commentService.update(articleId, request, commentId);
